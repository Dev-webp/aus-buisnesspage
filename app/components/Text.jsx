...
const Text = () => {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="flex flex-col space-y-8 sm:space-y-10 lg:items-start text-left max-w-2xl md:max-w-3xl mx-auto mb-0 lg:mb-0 relative z-10"
    >
      <motion.h1
      ...
      <motion.p
        ...
        className="flex text-gray-300 tracking-tight text-left md:font-medium max-w-xl lg:max-w-lg"
      >
